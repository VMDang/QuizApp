...
static constexpr auto qt_meta_stringdata_CLASSExamWindowENDCLASS = QtMocHelpers::stringData(
    "ExamWindow"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSExamWindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSExamWindowENDCLASS_t qt_meta_stringdata_CLASSExamWindowENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10)   // "ExamWindow"
    },
    "ExamWindow"
};
